...
public class QuickAction extends CustomPopupWindow {
	...
	private void createActionList() {
		...
		for (int i = 0; i < actionList.size(); i++) {
			...
			View sl = new View(context);
			sl.setLayoutParams(new LayoutParams(2, LayoutParams.FILL_PARENT));
			sl.setBackgroundDrawable(context.getResources().getDrawable(R.drawable.background));
			mTrack.addView(sl, index++);
			
			mTrack.addView(view, index++);
			
			View sr = new View(context);
			sr.setLayoutParams(new LayoutParams(2, LayoutParams.FILL_PARENT));
			sr.setBackgroundDrawable(context.getResources().getDrawable(R.drawable.background));
			mTrack.addView(sr, index++);
		}
	}
